...
namespace NamwahSystem.Model.Func
{
    public class SplitOrder
    {
        ...
        public static List<SalesOrderLine> SortSOLinesByNeedDateAndPriority(List<SalesOrderLine> SOLines)
        {
            return SOLines.OrderBy(S => S.NeedDate).OrderByDescending(S => S.Priority).ToList();
        }
